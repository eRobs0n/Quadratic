...
При наведении курсора мыши на корни уравнения, он притягивается к ним, чтобы удобнее было смотреть числовые значения
Когда координатные оси выходят за границы - они отображаются сбоку экрана другим цветом
